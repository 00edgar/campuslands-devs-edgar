...
Vas a simular una situación de trabajo colaborativo relacionada con fútbol. Lo importante no es memorizar comandos, sino entender qué problema resuelve cada acción de Git.
...
Practicar actualización antes de trabajar.
...
4. Agrega solución del ejercicio.
5. Explica por qué pull reduce conflictos.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu carpeta personal dentro de esta ruta: `basico/git/ejercicio-06/resoluciones/nombre-apellido/`.
